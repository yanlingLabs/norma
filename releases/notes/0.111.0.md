...
already there). Nothing about your history or your logins needs redoing. Once Winter is running the way you expect, the old Norma.app can be deleted — nothing in `~/.norma` is needed for Winter to work, and the directory can go too once you have verified the migration.
