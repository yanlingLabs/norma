    ...
    private final class DocumentOfficeDriverRecorder: @unchecked Sendable {
        ...
        var driver: OfficeRuntime.Driver {
            OfficeRuntime.Driver(
                ...
                sheetsManageSheetBatch: { _, _ in throw OfficeHelperClientError.serverError(reason: "fake driver: sheets not implemented") },
                ...
                slidesManagePageBatch: { _, _ in throw OfficeHelperClientError.serverError(reason: "fake driver: slides not implemented") },
