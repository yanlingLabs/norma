...
// panel-cef Task 3: Winter's entry point.
//
// This file exists so that `NSApp` is a `WinterApplication` — the `CefAppProtocol`-conforming
...
// `WinterApplicationTests` now pins this file's effect at runtime instead. (Unrelated, still
...
//   1. `WinterApp` must NOT carry `@main` — `swiftc` rejects "'main' attribute cannot be used in
