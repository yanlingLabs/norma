/// The EFF "short" wordlist (2016), used to render a 4-word Short Authentication
/// String (SAS) for the phone<->Mac pairing ceremony (SP2b Task 2).
///
/// Source: https://www.eff.org/files/2016/09/08/eff_short_wordlist_1.txt
/// ("EFF Short Wordlist", from the EFF dice-generated passphrases project:
/// https://www.eff.org/dice -- accessed 2026-07-18.)
///
/// License: Creative Commons Attribution 3.0 Unported (CC BY 3.0) -- Electronic
/// Frontier Foundation. The dice-roll index column (1111-6666) from the source file
/// is dropped here; only the 1,296 words themselves are kept, alphabetically sorted
/// (the source file was already in this order).
///
/// PairingCrypto.sasWords indexes into this array with base-1296 digits derived
/// from an HMAC -- the array MUST stay exactly 1,296 entries, in exactly this order,
/// or previously-verified SAS codes become unreproducible.
public let effShortWordlist: [String] = [
