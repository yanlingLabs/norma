// Pure/isolatable logic behind `winter output-style ...`, split out of main.ts so it can be
...
/** Parses `winter output-style`'s argv tail (everything after "output-style", i.e.
