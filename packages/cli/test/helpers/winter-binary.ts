...
// `NORMA_WINTER_EXECUTABLE` unset ⇒ SKIP (a local run without a build); `NORMA_WINTER_REQUIRE_BINARY=1`
 ...
 *  `NORMA_WINTER_REQUIRE_BINARY=1`, at import). For files that mix session-creating tests with
